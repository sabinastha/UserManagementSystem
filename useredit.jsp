			...
			<div style="margin-left: 33%;" class="col-md-push-4 col-md-4">
				<form action="userupdate" method="post">
					...
					<div class="form-group">
						<label>UserID</label>
						<input required readonly="true" type="text" name="id" value="<%=id%>" class="form-control">
					</div>

					<div class="form-group">
						<label>Username</label>
						<input required type="text" name="username" value="<%=username%>" class="form-control">
					</div>

					<div class="form-group">
						<label>Full Name</label>
						<input required type="text" name="fullname" value="<%=fullname%>" class="form-control">
					</div>

					<div class="form-group">
						<label>Password</label>
						<input required type="password" name="password" value="<%=password%>" class="form-control">
					</div>
